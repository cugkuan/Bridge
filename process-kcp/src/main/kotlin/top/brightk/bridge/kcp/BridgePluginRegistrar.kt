...
class BridgePluginRegistrar  : CompilerPluginRegistrar(), ComponentRegistrar {
    ...
    override fun registerProjectComponents(
        ...
        IrGenerationExtension.registerExtension(project, BridgeIrGenerationExtension(configuration.getLogger()))
    }
}
