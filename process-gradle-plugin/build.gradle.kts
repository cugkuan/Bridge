...
dependencies {
    ...
    // Force Kotlin version to avoid leaks from gradleApi()
    constraints {
...
mavenPublishing {
    ...
    signAllPublications()
    coordinates("top.brightk", "bridge-plugin",
        project.version.toString())

    pom {
        // public maven must
        name.set("Bridge ksp")
        description.set("Bridge ksp,work for Bridge;gradle  plugin ，挂载插件使用")
